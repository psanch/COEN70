...
//INVARIANT: Valid polynomials are dynamic arrays size coef_size. Current_degree stores the highest order coefficient. The empty polynomial will be initialized for degree 1 and coef 0.0.

//VALUE SEMANTICS: Copy constructor and assignment operator may be used with polynomials.
