...
//   void checktail()
//     Postcondition: Tail is properly updated to be the last item in the sequence.
//
//   void advance( )
...
//INVARIANT:
// Sequences are a list of doubles implemented with a singularly linked list. The user can only advance forward through the list (or return to the beginning) to traverse it. many_nodes holds how many nodes are currently in the list. Head_ptr and tail_ptr hold the beginning and end of the list, respectively. Cursor holds the current item, and pre_cursor is its auxiliary to be able to do certain functions properly(insert,attach,remove_current). 
