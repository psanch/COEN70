...
//INVARIANT: Linked lists are singularly linked, containing a link_field to the next node and a data_field for it's value_type data. They are designated by a pointer to their first element dubbed their "head".

//VALUE SEMANTICS:
// No assignment operator nor copy constructor are provided intrinsically for the node class. However, the list_copy and list_copy_segment provide a similar functionality.
